          ...
          <div className="column is-mobile-12 is-desktop-9">
            <div className="blog-list-wrap is-space-xxxl">
              ...
              <ul className="pagenation">
                    ...
                    <Link
                      to={
                        pageContext.currentPage === 2
                          ? `/archive/${pageContext.displayYear}/`
                          : `/archive/${pageContext.displayYear}/${pageContext.currentPage - 1}`
                      }
                      rel="prev"
                    >
                ...
                {!pageContext.isLast && (
                  <li className="next">
                    <Link to={`/archive/${pageContext.displayYear}/${pageContext.currentPage + 1}/`} rel="next">
                      <span>次のページ</span>
